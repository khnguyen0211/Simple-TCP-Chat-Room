 ...
 * @author pnkn0
 */
public class ClientWithCaesar extends javax.swing.JFrame {
    ...
    public ClientWithCaesar(String username, String fullName) {
        initComponents();
        setDefaultCloseOperation(this.DISPOSE_ON_CLOSE);
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        int width = this.getSize().width;
    ...
    private void initComponents() {
        ...
        btnConnect.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        ...
        if (!flag) {
            ...
            if (!flag) {
                ...
                try {
                    ...
                    if (mngSocket != null) {
                        //Tạo luồng
                        EncryptPanel p = new EncryptPanel(mngSocket, staffName, "Manager", userName);
...
//                        this.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientWithCaesar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientWithCaesar().setVisible(true);
            }
        });
    }
