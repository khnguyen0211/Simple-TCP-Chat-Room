 ...
 * @author pnkn0
 */
public class ManagerReceiveFile extends javax.swing.JFrame implements Runnable {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerReceiveFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerReceiveFile().setVisible(true);
            }
        });
    }
        ...
        while (true) {
            try {
                ...
                if (staffSocket != null) {
                    ...
                    int pos = s.indexOf(":");
                    String staffName = s.substring(pos + 1).trim();
                    SendFilePanel p = new SendFilePanel(staffSocket, "Manager", staffName);
