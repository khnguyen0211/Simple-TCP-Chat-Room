...
import panels.DecryptPanel;

/**
 *
 * @author pnkn0
 */
public class ManagerWithCaesar extends javax.swing.JFrame implements Runnable {
     ...
     */
    public ManagerWithCaesar() {
        initComponents();
        setDefaultCloseOperation(this.DISPOSE_ON_CLOSE);
        setDefaultCloseOperation(this.DO_NOTHING_ON_CLOSE);

        // Thêm xử lý sự kiện cho nút Close
    ...
    private void initComponents() {
        ...
        txtPort.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagerWithCaesar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagerWithCaesar().setVisible(true);
            }
        });
    }
    ...
    public void run() {
        while (true) {
            try {
                ...
                if (staffSocket != null) {
                    bf = new BufferedReader(new InputStreamReader(staffSocket.getInputStream()));
                    String s = bf.readLine();
                    String message = s;
                    int pos = message.indexOf(":");
                    String staffName = message.substring(pos + 1).trim();

                    DecryptPanel p = new DecryptPanel(staffSocket, "Manager", staffName);
                    p.setSize(640, 400);
